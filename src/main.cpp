...
void generateParametricToolMesh(Mesh& mesh, const Config& config) {
    ...
    if (type == MachiningType::MILLING || type == MachiningType::DRILLING || type == MachiningType::REAMING || type == MachiningType::THREADING || type == MachiningType::BORING) {
        // Cylinder (with point for drilling, flat for milling/others)
...
int main(int argc, char* argv[]) {
    ...
    try {
...

        {
            ...
            if (config.getMachiningType() != MachiningType::MILLING) {

...
int main(int argc, char* argv[]) {
    ...
    try {
...

        {
            ...
            // contactRadius = 2.0 × h — doubled for reliable engagement in drilling.
            // At 1.0×h the drill tip chisel zone missed particles inside the tool body.
            // The tool (D=10mm) overlaps deeply into the workpiece and particles end up
            // INSIDE the tool, not at the boundary — a larger detection radius catches them.
            contactCfg.contactRadius = sphCfg.smoothingRadius * 2.0;

...
bool SimulationEngine::step(double dt) {
    ...
    if (m_strategy) {
        ...
        // =====================================================================
        // FIX: The strategy's macroscopic cutting forces are no longer 
        // injected back into the SPH workpiece particles as an external force.
        // Doing so causes a "double-dipping" paradox because the ContactSolver
        // already applies physical reaction forces from the tool geometry.
        // The strategy is strictly an empirical/logging model now.
        // =====================================================================
    }

...
public:
    ...
    /**
     * @brief Get total internal energy (J)
     */
    virtual double getTotalInternalEnergy() const { return 0.0; }
...
public:
    ...
    /**
     * @brief Set particle temperatures in bulk (for CFD→MPM feedback)
     * @param temperatures Array of temperatures (°C), one per particle
     * @param count Number of particles
     */
    virtual void setParticleTemperatures(const double* temperatures, int count) {}
};

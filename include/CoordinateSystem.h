...
public:
     ...
     */
    static void transformParticles(std::vector<MPMParticle>& particles, const Mat4& transform) {
     ...
     */
    static BoundingBox computeBoundingBox(const std::vector<MPMParticle>& particles) {
        BoundingBox bb;

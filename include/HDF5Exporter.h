...
public:
    ...
    void exportMetrics(int step, double time,
                       double maxStress, double maxTemp) override;
     ...
     */
    void exportParticles(int step, double time, const std::vector<MPMParticle>& particles);

...
struct HealthMonitorConfig {
    ...
    // Energy
    // BUG 7 FIX: Raised from 100× to 500× for drilling.
    // During chip ejection, contact count can drop to 0 for 1-2 steps while
    // particles with high plastic strain release. Legitimate KE spikes up to
    // ~300× occur. 500× still catches real explosions.
    double energyJumpMultiplier = 500.0;      // HALT if KE jumps > 500×
